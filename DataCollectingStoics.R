...
consumerKey =  #No key included to maintain privacy
consumerSecret = #No key included to maintain privacy
accessToken = #No key included to maintain privacy
accessSecret = #No key included to maintain privacy
...
# Turning the data returned into data frames and creating a CSV file for each.
